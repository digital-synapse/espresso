...
"</head><body><h1>Device Setup</h1><p>Please enter your wireless network info below.</p><small><form action='/' method='post'><div>Wifi SSID<br/><select id='ssids' name='ssids' required>";
